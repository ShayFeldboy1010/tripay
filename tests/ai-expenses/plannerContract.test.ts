        ...
        choices: [
          {
            message: {
              content: JSON.stringify({
                ...
                order: [],
                limit: 50,
                sql: "SELECT category, currency, SUM(amount) AS sum FROM expenses GROUP BY category, currency LIMIT 50",
              }),
            },
          },
        ],
        ...
        choices: [
          {
            message: {
              content: JSON.stringify({
                ...
                order: [],
                limit: 5,
                sql: "SELECT date, amount FROM expenses ORDER BY amount DESC LIMIT 5",
              }),
            },
          },
        ],
