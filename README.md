...
- The backend automatically selects Groq when an API key is present and defaults to the `openai/gpt-oss-120b` model. Override with `LLM_MODEL` if you prefer a different Groq deployment.
